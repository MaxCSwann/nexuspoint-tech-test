    ...
    return(
        <article className={styles.card} title={name}>
            ...
            <div className={styles.details}>
                <div className={styles.card_footer_top}>
                    ...
                    </div>
                    {
                        isMobile && (
                            <div className={styles.listing_tag_container}>
                                <Tag data={data.advert_classification} size="md"/>
                            </div>
                        )
                    }
                ...
                <div class={styles.card_footer_bottom}>
                    {
                        isMobile && (
